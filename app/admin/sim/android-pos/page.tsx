// app/admin/sim/android-pos/page.tsx
"use client";
...
function eventLabel(event_type: string): { icon: string; label: string } {
  const map: Record<string, { icon: string; label: string }> = {
    ...
    CUSTOMER_JOINED: { icon: "👤", label: "Customer joined" },
...
export default function AndroidPosSimPageA6() {
        ...
        async (msg: BroadcastMessage) => {
          ...
          if (evUnknown.type === "CUSTOMER_SCANNED") {
            ...
            await persistAndBroadcast(nextSnap, "CUSTOMER_SCANNED", {
              ...
              message,
              token_id: snapNow.receipt?.token_id ?? null,
            } as unknown as JsonObject);
  ...
  return (
    <div style={{ padding: 24, maxWidth: 1320 }}>
      <h1 style={{ fontSize: 22, fontWeight: 800 }}>
        Receiptless POS Simulator — Android POS Host (A6)
      </h1>
      <p style={{ marginTop: 8 }}>
        ...
        drives UI sync. Sale grouping preserved via <b>sale_id</b>.
      </p>
      ...
      {!session ? (
        <div style={{ marginTop: 20 }}>
          ...
          <div style={{ marginTop: 10, fontSize: 13, opacity: 0.8 }}>
            Module: <b>android_pos</b> (host UI)
          </div>
        </div>
      ) : (
        <div
        ...
        >
          ...
          {/* Right column (Android Host UI look) */}
          <div
            style={{
              flex: 1.5,
              minWidth: 560,
          ...
          >
            ...
            >
              <div style={{ fontSize: 12, opacity: 0.75, fontWeight: 800 }}>
                Android POS Host (simulated UI shell)
              </div>
              <div
                style={{
                  marginTop: 8,
              ...
              >
                ...
                >
                  {issuanceState === "INGESTING" ? "Issuing..." : "Issue"}
                </button>
              ...
              <div style={{ marginTop: 12 }}>
                ...
                {issuanceState === "FAILED" && (
                  <div style={{ opacity: 0.85, marginTop: 6 }}>
                    Issuance failed. Retry with <b>Issue</b>. Fallback print
